...
const modulaName = "payment_received";
// fetch
export const fetchPaymentReceives = async (req: Request, res: Response) => {
  try {
...
// // SHOW
export const fetchPaymentReceive = async (req: Request, res: Response) => {
...
// // CREATE
export const createPaymentReceive = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const [result]: any = await connection.execute(
      "INSERT INTO payments (invoice_id, customer_id, payment_date, payment_method, amount, notes) VALUES (?, ?, ?, ?, ?, ?)",
      [invoice_id, customer_id, payment_date, payment_method, amount, notes]
    );
...
// UPDATE
export const updatePaymentReceive = async (req: Request, res: Response) => {
  try {
    const {
      invoice_id,
      customer_id,
